...
### 1. Foundations: Expressions, Equations, and Inequalities
...
These include **expressions**, **equations**, and **inequalities** — the fundamental language of algebra.
...
1. Which values satisfy the inequality $s < 0$?
   (Hint: What does this tell you about sentiment?)
