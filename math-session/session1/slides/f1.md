...
![Matrix Addition](https://latex.codecogs.com/png.image?\dpi{120} \begin{bmatrix}1&2\\3&4\end{bmatrix} + \begin{bmatrix}5&6\\7&8\end{bmatrix} = \begin{bmatrix}6&8\\10&12\end{bmatrix})
...
Then the result \$C = AB\$ is \$m \times p\$
