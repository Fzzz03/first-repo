...
To make this real, imagine Alex, a data scientist.
His goal is to predict how a company’s stock price might move by analyzing news articles.

Let’s say Alex uses AI to assign a **sentiment score** to each piece of news, where positive news gives a high score and negative news gives a low score.

But how does the AI turn these sentiment scores into predictions about stock price changes?
